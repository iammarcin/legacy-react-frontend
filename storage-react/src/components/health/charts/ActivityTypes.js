...
const ActivityTypes = ({ index, data, startDate, endDate, isFullWidth, isMobile, isModalOpen, onChartClick }) => {
  ...
  const processData = useCallback(() => {
    ...
    const chartData = groupAndProcessDataForGraph(data, startDate, endDate, keys, transformFunction, colors, labels, 'activity_type', null);
